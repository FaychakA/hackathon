...
const PostPage = ({ postId }) => {
  ...
  return (
    <div className="post-page">
      ...
      <Row>
        <Col>
          <Form className="post-page__border post-page__border--form" onSubmit={(e) => handleAddComment(e)}>
      ...
      <div className="post-page__border">
        {
          Object.keys(posts.byId[id]?.comments).reverse().map((commentId) => (
            <div className="post-page__comment" key={commentId}>
              <div className="post-page__user-info">
                <div>
                  <img className="post-page__user-avatar" src={users.byId[posts.byId[id]?.comments[commentId].userId]?.profilePic} alt="user" />
                </div>
